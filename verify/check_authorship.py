...
def main(argv):
    ...
    if explicit:
        ...
        if changes is None:
            # A git failure means the check did not run; exiting 0 would
            # let a broken diff silently pass authorship in CI (issue #594
            # pass 5, P2). Fail closed, like gate_changed.py does.
