...
Amicode harness, repo kit (`css.py`, `gf2_fast`, `submit.py`), `validate_candidate` gate. Compute: ~10 min on erlich (24c, 200 seeds × 5k RIS) + mini (10c) mirror. Model `Kimi K3` (provenance).
