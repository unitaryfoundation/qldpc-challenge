...
The independent structural checks report `rank(H_X)=rank(H_Z)=250`, `k=182`, zero CSS commutation violations, and valid nontrivial witnesses of weight 77. The 2M campaign took about 853 seconds on the local native kernel. Direct comparison with the public `[[682,182,75]]` reference shows all 682 X/Z support rows differ; exact fingerprints are `a7f4bd0ae2cdbf77` versus `818c9946d1c6caeb`, and Weisfeiler–Leman signatures are `df8ed63580f04818` versus `0406293c02e90dff`.
